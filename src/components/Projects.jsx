const Projects = () => {
    const myProjects = [
        {
            image: '',
            title: 'Memphis Employee Insights',
            dates: 'Jan 2026 - Mar 2026',
            description: 'Discover clear, interactive insights into the City of Memphis, Tennessee employee salaries with detailed charts and analysis. Explore pay ranges, department breakdowns, and workforce trends across all divisions within the city\'s total salaried payroll of $477.5 million. Whether you are a resident, researcher, or prospective employee, this tool provides transparent visibility into how the city allocates its largest budget expense: its people.',
            technology: [
                'Python',
                'Pandas',
            ...
            website: 'https://memphisinsights.com/',
            source: 'https://github.com/jasonniebauer/memphis-employee-insights'
        },
        {
            image: '',
            title: 'DOGE Insights',
        ...
        },
        {
            ...
            technology: [
                ...
                'Data Visualization',
                'Interactive Dashboards & Radar Charts',
                'Plotly / Plotly Dash',
                'React.js',
                'Full-Stack Development',
                'UI/UX Design',
            ...
            source: 'https://github.com/jasonniebauer/baskethogs'
        },
        {
            image: '',
            title: 'CryptoTab',
