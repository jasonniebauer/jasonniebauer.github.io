    ...
    const myProjects = [
        {
            ...
            technology: ['Python', 'React', 'Statistical Analysis', 'SQL', 'Pandas','Machine Learning', 'Database Design', 'Recharts'],
        ...
        },
        {
            ...
            technology: ['Python', 'React', 'Government API', 'SQL', 'Pandas', 'Database Design'],
        ...
        },
        {
            ...
            technology: ['Python', 'JavaScript', 'Coinbase API', 'CoinGecko API', 'CoinPaprika API', 'Custom CSS', 'React - In Progress'],
        ...
        },
        {
            ...
            description: 'Open source API for developers to access 1,089,057 articles on Grokipedia. Great for training models, analyzing text patterns, and incorporating into your project.',
            technology: ['Python', 'FastAPI', 'Web Scraping', 'API Design', 'Vercel', 'Machine Learning'],
